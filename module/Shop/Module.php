	...
	public function getServiceConfig(){
		return array(
				'factories'	=> array(
						...
						'Shop\Model\SysfunctionTable'	=> function ($sm) {
							$tableGateway	= $sm->get('SysfunctionTableGateway');
							return new \Shop\Model\SysfunctionTable($tableGateway);
						},
	...
	public function getViewHelperConfig(){
		return array(
				'invokables'	=> array(
						...
						'LinkSysfunction'  	=> '\Zendvn\View\Helper\Url\LinkSysfunction'
				...
				'factories'	=> array(
					...
					'blkSysfunction'		=> function($sm){
						$helper	= new \Block\BlkSysfunction();
						$helper->setData($sm->getServiceLocator()->get('Shop\Model\SysfunctionTable'),$sm->getServiceLocator()->get('Shop\Model\SysfunctionTable'));
						return $helper;
					},
