...
class VisaofficesController extends ActionController
{
	public function init(){
		...
		$this->_options['tableName']	= 'Admin\Model\VisaofficesTable';
		$this->_options['formName']		= 'formAdminVisaoffices';
    ...
    public function indexAction()
    {
    	...
    	$parentById	= $this->getServiceLocator()->get('Admin\Model\VisaofficesTable')->parentById($this->_params['ssFilter'],null);
    	$slbParent	= $this->getServiceLocator()->get('Admin\Model\VisaofficesTable')->itemInSelectbox($this->_params['ssFilter'],null);
    ...
    public function formAction()
    {
    	...
    	//GET PARENT BY ID
    	$parentById	= $this->getServiceLocator()->get('Admin\Model\VisaofficesTable')->parentById($this->_params['ssFilter'],array('task'=>'form-visaoffices'));
    	//CREATE SELECTBOX
    	$slbParent	= $this->getServiceLocator()->get('Admin\Model\VisaofficesTable')->itemInSelectbox($this->_params['ssFilter'],array('task'=>'form-visaoffices'));
    	//DATA PUT OUT VIEW
    	return new ViewModel(array(
    			'myForm'		=> $myForm,
