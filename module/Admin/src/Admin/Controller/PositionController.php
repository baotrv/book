...
class PositionController extends ActionController
{
	public function init(){
		...
		$this->_options['tableName']	= 'Admin\Model\PositionTable';
		$this->_options['formName']		= 'formAdminPosition';
    ...
    public function indexAction()
    {
    	...
    	$parentById	= $this->getServiceLocator()->get('Admin\Model\PositionTable')->parentById($this->_params['ssFilter'],null);
    	$slbParent	= $this->getServiceLocator()->get('Admin\Model\PositionTable')->itemInSelectbox($this->_params['ssFilter'],null);
    ...
    public function formAction()
    {
    	...
    	//GET PARENT BY ID
    	$parentById	= $this->getServiceLocator()->get('Admin\Model\PositionTable')->parentById($this->_params['ssFilter'],array('task'=>'form-position'));
    	//CREATE SELECTBOX
    	$slbParent	= $this->getServiceLocator()->get('Admin\Model\PositionTable')->itemInSelectbox($this->_params['ssFilter'],array('task'=>'form-position'));
    	//DATA PUT OUT VIEW
    	return new ViewModel(array(
    			'myForm'		=> $myForm,
