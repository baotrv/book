...
class CertifiedpaperController extends ActionController
{
	public function init(){
		...
		$this->_options['tableName']	= 'Admin\Model\CertifiedpaperTable';
		$this->_options['formName']		= 'formAdminCertifiedpaper';
    ...
    public function indexAction()
    {
    	...
    	$parentById	= $this->getServiceLocator()->get('Admin\Model\CertifiedpaperTable')->parentById($this->_params['ssFilter'],null);
    	$slbParent	= $this->getServiceLocator()->get('Admin\Model\CertifiedpaperTable')->itemInSelectbox($this->_params['ssFilter'],null);
    ...
    public function formAction()
    {
    	...
    	//GET PARENT BY ID
    	$parentById	= $this->getServiceLocator()->get('Admin\Model\CertifiedpaperTable')->parentById($this->_params['ssFilter'],array('task'=>'form-certifiedpaper'));
    	//CREATE SELECTBOX
    	$slbParent	= $this->getServiceLocator()->get('Admin\Model\CertifiedpaperTable')->itemInSelectbox($this->_params['ssFilter'],array('task'=>'form-certifiedpaper'));
    	//DATA PUT OUT VIEW
    	return new ViewModel(array(
    			'myForm'		=> $myForm,
