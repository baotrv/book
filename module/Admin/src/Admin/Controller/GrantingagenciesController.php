...
class GrantingagenciesController extends ActionController
{
	public function init(){
		...
		$this->_options['tableName']	= 'Admin\Model\GrantingagenciesTable';
		$this->_options['formName']		= 'formAdminGrantingagencies';
    ...
    public function indexAction()
    {
    	...
    	$parentById	= $this->getServiceLocator()->get('Admin\Model\GrantingagenciesTable')->parentById($this->_params['ssFilter'],null);
    	$slbParent	= $this->getServiceLocator()->get('Admin\Model\GrantingagenciesTable')->itemInSelectbox($this->_params['ssFilter'],null);
    ...
    public function formAction()
    {
    	...
    	//GET PARENT BY ID
    	$parentById	= $this->getServiceLocator()->get('Admin\Model\GrantingagenciesTable')->parentById($this->_params['ssFilter'],array('task'=>'form-grantingagencies'));
    	//CREATE SELECTBOX
    	$slbParent	= $this->getServiceLocator()->get('Admin\Model\GrantingagenciesTable')->itemInSelectbox($this->_params['ssFilter'],array('task'=>'form-grantingagencies'));
    	//DATA PUT OUT VIEW
    	return new ViewModel(array(
    			'myForm'		=> $myForm,
