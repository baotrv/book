...
class ComponentprofilesController extends ActionController
{
	public function init(){
		...
		$this->_options['tableName']	= 'Admin\Model\ComponentprofilesTable';
		$this->_options['formName']		= 'formAdminComponentprofiles';
    ...
    public function indexAction()
    {
    	...
    	$parentById	= $this->getServiceLocator()->get('Admin\Model\ComponentprofilesTable')->parentById($this->_params['ssFilter'],null);
    	$slbParent	= $this->getServiceLocator()->get('Admin\Model\ComponentprofilesTable')->itemInSelectbox($this->_params['ssFilter'],null);
    ...
    public function formAction()
    {
    	...
    	//GET PARENT BY ID
    	$parentById	= $this->getServiceLocator()->get('Admin\Model\ComponentprofilesTable')->parentById($this->_params['ssFilter'],array('task'=>'form-componentprofiles'));
    	//CREATE SELECTBOX
    	$slbParent	= $this->getServiceLocator()->get('Admin\Model\ComponentprofilesTable')->itemInSelectbox($this->_params['ssFilter'],array('task'=>'form-componentprofiles'));
    	//DATA PUT OUT VIEW
    	return new ViewModel(array(
    			'myForm'		=> $myForm,
