...
class CareerController extends ActionController
{
	public function init(){
		...
		$this->_options['tableName']	= 'Admin\Model\CareerTable';
    ...
    public function indexAction()
    {
    	...
    	$parentById	= $this->getServiceLocator()->get('Admin\Model\CareerTable')->parentById($this->_params['ssFilter'],null);
    	$slbParent	= $this->getServiceLocator()->get('Admin\Model\CareerTable')->itemInSelectbox($this->_params['ssFilter'],null);
    ...
    public function formAction()
    {
    	...
    	//GET PARENT BY ID
    	$parentById	= $this->getServiceLocator()->get('Admin\Model\CareerTable')->parentById($this->_params['ssFilter'],array('task'=>'form-career'));
    	//CREATE SELECTBOX
    	$slbParent	= $this->getServiceLocator()->get('Admin\Model\CareerTable')->itemInSelectbox($this->_params['ssFilter'],array('task'=>'form-career'));
    	//DATA PUT OUT VIEW
    	return new ViewModel(array(
    			'myForm'		=> $myForm,
