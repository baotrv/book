...
class CountryController extends ActionController
{
	public function init(){
		...
		$this->_options['tableName']	= 'Admin\Model\CountryTable';
		$this->_options['formName']		= 'formAdminCountry';
    ...
    public function indexAction()
    {
    	...
    	$parentById	= $this->getServiceLocator()->get('Admin\Model\CountryTable')->parentById($this->_params['ssFilter'],null);
    	$slbParent	= $this->getServiceLocator()->get('Admin\Model\CountryTable')->itemInSelectbox($this->_params['ssFilter'],null);
    ...
    public function formAction()
    {
    	...
    	//GET PARENT BY ID
    	$parentById	= $this->getServiceLocator()->get('Admin\Model\CountryTable')->parentById($this->_params['ssFilter'],array('task'=>'form-country'));
    	//CREATE SELECTBOX
    	$slbParent	= $this->getServiceLocator()->get('Admin\Model\CountryTable')->itemInSelectbox($this->_params['ssFilter'],array('task'=>'form-country'));
    	//DATA PUT OUT VIEW
    	return new ViewModel(array(
    			'myForm'		=> $myForm,
