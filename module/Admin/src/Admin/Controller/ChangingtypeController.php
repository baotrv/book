...
class ChangingtypeController extends ActionController
{
	public function init(){
		...
		$this->_options['tableName']	= 'Admin\Model\ChangingtypeTable';
		$this->_options['formName']		= 'formAdminChangingtype';
    ...
    public function indexAction()
    {
    	...
    	$parentById	= $this->getServiceLocator()->get('Admin\Model\ChangingtypeTable')->parentById($this->_params['ssFilter'],null);
    	$slbParent	= $this->getServiceLocator()->get('Admin\Model\ChangingtypeTable')->itemInSelectbox($this->_params['ssFilter'],null);
    ...
    public function formAction()
    {
    	...
    	//GET PARENT BY ID
    	$parentById	= $this->getServiceLocator()->get('Admin\Model\ChangingtypeTable')->parentById($this->_params['ssFilter'],array('task'=>'form-changingtype'));
    	//CREATE SELECTBOX
    	$slbParent	= $this->getServiceLocator()->get('Admin\Model\ChangingtypeTable')->itemInSelectbox($this->_params['ssFilter'],array('task'=>'form-changingtype'));
    	//DATA PUT OUT VIEW
    	return new ViewModel(array(
    			'myForm'		=> $myForm,
