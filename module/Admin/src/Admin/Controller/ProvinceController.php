...
class ProvinceController extends ActionController
{
	public function init(){
		...
		$this->_options['tableName']	= 'Admin\Model\ProvinceTable';
		$this->_options['formName']		= 'formAdminProvince';
    ...
    public function indexAction()
    {
    	...
    	$parentById	= $this->getServiceLocator()->get('Admin\Model\ProvinceTable')->parentById($this->_params['ssFilter'],null);
    	$slbParent	= $this->getServiceLocator()->get('Admin\Model\ProvinceTable')->itemInSelectbox($this->_params['ssFilter'],null);
 ...
 public function deleteAction()
    ...
    public function formAction()
    {
    	...
    	//GET PARENT BY ID
    	$parentById	= $this->getServiceLocator()->get('Admin\Model\ProvinceTable')->parentById($this->_params['ssFilter'],array('task'=>'form-province'));
    	//CREATE SELECTBOX
    	$slbParent	= $this->getServiceLocator()->get('Admin\Model\ProvinceTable')->itemInSelectbox($this->_params['ssFilter'],array('task'=>'form-province'));
    	//DATA PUT OUT VIEW
    	return new ViewModel(array(
    			'myForm'		=> $myForm,
