...
class CitizenController extends ActionController
{
	public function init(){
		...
		$this->_options['tableName']	= 'Admin\Model\CitizenTable';
		$this->_options['formName']		= 'formAdminCitizen';
    ...
    public function indexAction()
    {
    	...
    	$parentById	= $this->getServiceLocator()->get('Admin\Model\CitizenTable')->parentById($this->_params['ssFilter'],null);
    	$slbParent	= $this->getServiceLocator()->get('Admin\Model\CitizenTable')->itemInSelectbox($this->_params['ssFilter'],null);
    ...
    public function formAction()
    {
    	...
    	//GET PARENT BY ID
    	$parentById	= $this->getServiceLocator()->get('Admin\Model\CitizenTable')->parentById($this->_params['ssFilter'],array('task'=>'form-citizen'));
    	//CREATE SELECTBOX
    	$slbParent	= $this->getServiceLocator()->get('Admin\Model\CitizenTable')->itemInSelectbox($this->_params['ssFilter'],array('task'=>'form-citizen'));
    	//DATA PUT OUT VIEW
    	return new ViewModel(array(
    			'myForm'		=> $myForm,
